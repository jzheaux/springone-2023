...
/**
 * Custom implementation of {@link org.springframework.security.oauth2.server.authorization.oidc.web.OidcLogoutEndpointFilter}
 * that allows customization of the {@link #logoutSuccessHandler}.
 * This is needed because we want the OIDC Logout to also terminate the session
 * with the SAML 2.0 IdP, otherwise it wouldn't be possible.
 */
public class CustomOidcLogoutEndpointFilter extends OncePerRequestFilter {
	...
	public CustomOidcLogoutEndpointFilter(AuthenticationManager authenticationManager,
		...
		this.logoutSuccessHandler = new PostLogoutRedirectUriLogoutSuccessHandler();
